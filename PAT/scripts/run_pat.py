...
def run_PAT(run_name='', use_wandb=False, use_multi_id_training=True):
    os.environ['CUDA_DEVICE_ORDER'] = 'PCI_BUS_ID'
    os.environ['CUDA_VISIBLE_DEVICES'] = global_config.cuda_visible_devices
    print(global_config.cuda_visible_devices)
    ...
    if use_multi_id_training:
        print(" WE ARE USING MULTI ID")
        coach = MultiIDCoach(dataloader, use_wandb)
    else:
        print(" WE ARE USING SINGLE ID")
