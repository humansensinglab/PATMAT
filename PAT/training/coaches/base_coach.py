...
class BaseCoach:
    ...
    def calc_loss(self, generated_images, real_images, new_G):
        loss = 0.0
        ...
        if hyperparameters.pt_lpips_lambda > 0:
            ...
            #print("ppp", loss_lpips)
            loss += loss_lpips * hyperparameters.pt_lpips_lambda
        
        #print(loss)
        return loss, l2_loss_val, loss_lpips

    def forward(self, real_images, w):
        #mask = torch.zeros(real_images.shape[0], 1, 512, 512).to(global_config.device)
        generated_images = self.G.synthesis(real_images,mask, w, noise_mode='const')
