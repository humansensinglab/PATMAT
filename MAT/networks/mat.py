...
class SynthesisNet(nn.Module):
    ...
    def forward(self, images_in, masks_in, ws, noise_mode='random', return_stg1=False):
        ...
        # encoder
        x1 = images_in * masks_in + out_stg1 * (1 - masks_in)
        x = torch.cat([masks_in - 0.5, x1, images_in * masks_in], dim=1)
        ...
        print(gs.shape, "gs gs gs gs gs")
        print(ws.shape, "ws ws ws ws ws")
        # decoder
